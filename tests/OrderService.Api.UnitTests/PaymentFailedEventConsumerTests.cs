...
public class PaymentFailedEventConsumerTests : IDisposable
{
    private readonly OrderDbContext _dbContext;
    private readonly ILogger<PaymentFailedEventConsumer> _logger;
    private readonly OrderMetrics _metrics;
    private readonly IMeterFactory _meterFactory;
    private readonly PaymentFailedEventConsumer _consumer;

    public PaymentFailedEventConsumerTests()
    {
        ...
        _logger = Substitute.For<ILogger<PaymentFailedEventConsumer>>();
        ...
        _consumer = new PaymentFailedEventConsumer(_dbContext, _logger, _metrics);
    }
